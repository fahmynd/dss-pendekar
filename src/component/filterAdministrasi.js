    ...
    const adm = useMemo(() => {
        ...
        if (selectedKec && selectedDesa) {
            ...
            if (deskel) {
                ...
                buku_peraturan_di_desa_add = parseInt(deskel.buku_peraturan_di_desa_add)
                buku_keputusan_kepala_desa = parseInt(deskel.buku_keputusan_kepala_desa)
                buku_keputusan_kepala_desa_add = parseInt(deskel.buku_keputusan_kepala_desa_add)
                buku_inventaris_dan_kekayaan_desa = parseInt(deskel.buku_inventaris_dan_kekayaan_desa)
                buku_inventaris_dan_kekayaan_desa_add = parseInt(deskel.buku_inventaris_dan_kekayaan_desa_add)
                buku_aparat_pemerintah_desa = parseInt(deskel.buku_aparat_pemerintah_desa)
                buku_aparat_pemerintah_desa_add = parseInt(deskel.buku_aparat_pemerintah_desa_add)
                ...
                buku_lembaran_desa_dan_berita_desa = parseInt(deskel.buku_lembaran_desa_dan_berita_desa)
                buku_lembaran_desa_dan_berita_desa_add = parseInt(deskel.buku_lembaran_desa_dan_berita_desa_add)
            }
        } else {
            if (selectedKec) {
                listDesa.forEach(desa => {
                    buku_peraturan_di_desa += parseInt(desa.buku_peraturan_di_desa);
                    buku_peraturan_di_desa_add += parseInt(desa.buku_peraturan_di_desa_add);
                    buku_keputusan_kepala_desa += parseInt(desa.buku_keputusan_kepala_desa);
                    buku_keputusan_kepala_desa_add += parseInt(desa.buku_keputusan_kepala_desa_add);
                    buku_inventaris_dan_kekayaan_desa += parseInt(desa.buku_inventaris_dan_kekayaan_desa);
                    buku_inventaris_dan_kekayaan_desa_add += parseInt(desa.buku_inventaris_dan_kekayaan_desa_add);
                    buku_aparat_pemerintah_desa += parseInt(desa.buku_aparat_pemerintah_desa);
                    buku_aparat_pemerintah_desa_add += parseInt(desa.buku_aparat_pemerintah_desa_add);
                    ...
                    buku_lembaran_desa_dan_berita_desa += parseInt(desa.buku_lembaran_desa_dan_berita_desa);
                    buku_lembaran_desa_dan_berita_desa_add += parseInt(desa.buku_lembaran_desa_dan_berita_desa_add);
                })
            } else {
                list_desa.forEach(d => {
                    ...
                    buku_keputusan_kepala_desa_add += parseInt(d.buku_keputusan_kepala_desa_add);
                    buku_inventaris_dan_kekayaan_desa += parseInt(d.buku_inventaris_dan_kekayaan_desa);
                    buku_inventaris_dan_kekayaan_desa_add += parseInt(d.buku_inventaris_dan_kekayaan_desa_add);
                    buku_aparat_pemerintah_desa += parseInt(d.buku_aparat_pemerintah_desa);
                    buku_aparat_pemerintah_desa_add += parseInt(d.buku_aparat_pemerintah_desa_add);
                    ...
                    buku_lembaran_desa_dan_berita_desa += parseInt(d.buku_lembaran_desa_dan_berita_desa);
                    buku_lembaran_desa_dan_berita_desa_add += parseInt(d.buku_lembaran_desa_dan_berita_desa_add);
                })
            }
        }
                                ...
                                <div className="card-body-info">
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="ps-2">
                                            ...
                                            <h6>{adm.buku_tanah_kas_desa}m<sup>2</sup></h6>
                                        </div>
                                        <div className="adm-umum small">
                                ...
                                <div className="card-body-info">
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="ps-2">
                                            ...
                                            <h6>{adm.buku_tanah_di_desa}m<sup>2</sup></h6>
                                        </div>
                                        <div className="adm-umum small">
