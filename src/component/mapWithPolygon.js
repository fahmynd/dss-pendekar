...
const getColorForValue = (value, property) => {
    const colorScales = {
        idm: ['#00DCB8', '#C2DCD8', '#96C4BC', '#6FABA1', '#4E9387', '#327A6E'],
...
const MapWithPolygons = (props) => {
    ...
    const generateLegend = () => {
        const thresholds = {
            idm: ['< 0,1', '0,1 - 0,3', '0,4 - 0,5', '0,6 - 0,6', '0,8 - 0,9', '> 0,9'],
            sdgs: ['< 10', '10 - 20', '21 - 30', '31 - 50', '51 - 80', '> 80'],
            ar: ['< 1', '1 - 3', '4 - 5', '6 - 8', '9 - 10', '> 10'],
            program: ['< 1', '1 - 3', '4 - 5', '6 - 8', '9 - 10', '> 10'],
            sda: ['< 1', '1 - 3', '4 - 5', '6 - 8', '9 - 10', '> 10'],
            sdm: ['< 100', '101 - 500', '501 - 1,000', '1,001 - 3,000', '3,001 - 5,000', '> 5,000'],
            lk: ['< 1', '1 - 3', '4 - 5', '6 - 8', '9 - 10', '> 10'],
            sarpras: ['< 1', '1 - 3', '4 - 5', '6 - 8', '9 - 10', '> 10'],
        };
                    ...
                    <div className='row'>
                        {legendValues.map((legend, index) => (
                            <div className="col-sm-4" key={index}>
                                <div className='row'>
                                    <p className="col-12">
                                        <i className="bi bi-square-fill" style={{ color: getColorForValue(index, selectedOption) }}></i> {legend}
                                    </p>
                                </div>
                            </div>
                        ))}
        ...
        <Fragment>
            ...
            >
                ...
                {polygonCoordDesa.map(({ polyDes, provinsi, kabupaten, kecamatan, deskel, kd, idm, sdgs, ar, program, sda, sdm, lk, sarpras }, index) => {
                    const desaColor = getColorForValue(sdm, selectedOption);
