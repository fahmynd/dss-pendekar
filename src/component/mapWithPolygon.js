...
const MapWithPolygons = props => {
	...
	const BASE_URL =
		SLUG === "localhost" ? "http://localhost:3000/assets/" : BASE_API_URL;
	...
	useEffect(() => {
		...
		const fetchDataMapDesa = (k1, k2, k3, k4) =>
			fetchDataMap(`${BASE_URL}assets/geojson/${k1}/${k2}/${k3}/${k4}.json`);
		...
		if (
			...
			if (newPolygonCoordKab && newPolygonCoordKab.k1 && newPolygonCoordKab.k2) {
