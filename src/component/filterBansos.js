          ...
          <div className="card-body">
            <div className="filter-primary">
              <button
                ...
                onClick={() => window.open(`${BASE_API_URL}export/bansos`)}
              >
                Export Report
              </button>
            </div>
                ...
                <div className="card">
                  <div className="card-body rounded-2 bg-primary">
                    <div className="row px-4 py-2">
                      <div className="col-6">
                        <span className="jum-bantuan timer count-title count-number">
                          {bansos.individu}
                        </span>{" "}
                        <br />
                        <span className="judul-card-bansos">
                          Penduduk Mendapat Bantuan
                        </span>
                      </div>
                  ...
                  <div className="card-body rounded-2 bg-secondary">
                    <div className="row px-4 py-2">
                      <div className="col-6">
                        ...
                        <br />
                        <span className="judul-card-bansos">
                          Kepala Keluarga Mendapat Bantuan
                        </span>
                      </div>
                      <div className="col-6 text-right center-v">
                        <img src={KK} width="60" />
