                                            ...
                                            <form>
                                                <div className="row mb-3">
                                                    ...
                                                    <div className="col-md-8 col-lg-9">
                                                        <img src="https://mitrasulawesi.id/wp-content/uploads/2022/10/IMG_20221014_232402.jpg" alt="Profile" />
                                                        <div className="pt-2">
                                                ...
                                                <div className="row mb-3">
                                                    <label htmlFor="fullName" className="col-md-4 col-lg-3 col-form-label">Nama</label>
                                                    <div className="col-md-8 col-lg-9">
                                                ...
                                                <div className="row mb-3">
                                                    <label htmlFor="Job" className="col-md-4 col-lg-3 col-form-label">Jabatan</label>
                                                    <div className="col-md-8 col-lg-9">
                                                ...
                                                <div className="row mb-3">
                                                    <label htmlFor="Address" className="col-md-4 col-lg-3 col-form-label">Alamat</label>
                                                    <div className="col-md-8 col-lg-9">
                                                ...
                                                <div className="row mb-3">
                                                    <label htmlFor="Phone" className="col-md-4 col-lg-3 col-form-label">No. HP</label>
                                                    <div className="col-md-8 col-lg-9">
